                ...
                <div className='flex flex-col flex-grow items-center mx-auto '>
                    ...
                    <div className=''>
                        ...
                        <form className="w-[500px] h-[600px]" onSubmit={formik.handleSubmit}>
                            ...
                            <div className='flex flex-row'>
                                <div className='mb-4 pr-5'>
                                    <label className="block text-gray-700 text-2xl font-semibold mb-2" htmlFor="costoMaterial">
                                        Coste
                                    </label>
                                    <input
                                        type='number'
                                    ...
                                    />
                                    <div className='mb-2'>
                                        <label className="block text-gray-700 text-2xl font-semibold mb-2" htmlFor="tipoTrabajo">
                                            Tipo de Trabajo
                                        </label>
                                        <select
                                            id="Tipotrabajo"
                                        ...
                                        >
                                            <option value=""></option>
                                            <option className='font-semibold text-gray-700 text-md'>Reparación</option>
                                            <option className='font-semibold text-gray-700 text-md'>Mecánica</option>
                                            <option className='font-semibold text-gray-700 text-md'>Reparación de chapa y pintura</option>
                                            <option className='font-semibold text-gray-700 text-md'>Revisión</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
